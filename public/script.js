       // ========== SISTEMA DE AUTENTICAÇÃO E SINCRONIZAÇÃO ==========
        ...
        function setupEventListeners() {
            ...
            // Configura navegação - ADICIONADO AGORA
        ...
        function login() {
            ...
            if (user) {
                ...
                // Salva informações de login se "Lembrar-me" estiver marcado
                if (rememberMe) {
        ...
        // Processa o registro de nova conta
        function register() {
            ...
            if (users.some(u => u.email === email)) {
                showMessage('Este e-mail já está em uso.', 'danger');
                return;
            }
            ...
            // Mensagem de sucesso e volta para o login
